                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                            <div className="bg-neutral-900/50 backdrop-blur-sm border border-white/5 rounded-sm p-4 flex flex-col items-center text-center">
                                ...
                                <p className="text-neutral-400 text-xs">123 Elite Fitness Blvd</p>
                            </div>
                            ...
                            <div className="bg-neutral-900/50 backdrop-blur-sm border border-white/5 rounded-sm p-4 flex flex-col items-center text-center">
                                ...
                                <p className="text-neutral-400 text-xs">+1 (555) 123-4567</p>
                            </div>
                            ...
                            <div className="bg-neutral-900/50 backdrop-blur-sm border border-white/5 rounded-sm p-4 flex flex-col items-center text-center">
                                ...
                                <p className="text-neutral-400 text-xs">info@elitefitness.com</p>
                            </div>
                        </div>
